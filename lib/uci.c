 ...
 * until those changes are written out to disk or discarded.
 *
 ...
 *
 * Returns the auto-generated, ephemeral name of the added unnamed section
 * on success.
 *
 ...
 *
 * Returns `null` on error, e.g. if the targeted option was not found or if an
