...
/* Internal platform helpers: byte-order, execvpe, pipe2/sigtimedwait. */

#ifndef UCODE_INTERNAL_PLATFORM_H
#define UCODE_INTERNAL_PLATFORM_H
...
#endif /* UCODE_INTERNAL_PLATFORM_H */
